...
//-------- Currently Commented out as not used for this release.


/*
class FeedViewController: UIViewController,  CLLocationManagerDelegate, MKMapViewDelegate, UITableViewDataSource, UITableViewDelegate {
    ...
    func refreshLabels(record: WalkData){
        ...
        gainLabel.text = "Cummalative Evelation Gain: \(record.evelvationGain)"
